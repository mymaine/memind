...
export function HeartbeatSection(): React.ReactElement {
  ...
  return (
    <section
      ...
      className="flex flex-col gap-4 rounded-[var(--radius-card)] border border-border-default bg-bg-primary p-6"
    >
      <header className="flex items-center justify-between">
        <span className="font-[family-name:var(--font-sans-display)] text-[14px] font-semibold uppercase tracking-[0.5px] text-fg-tertiary">
          Heartbeat — independent run
        </span>
        <span className="font-[family-name:var(--font-mono)] text-[11px] text-fg-tertiary">
          3 ticks · 10s interval
        </span>
      </header>
